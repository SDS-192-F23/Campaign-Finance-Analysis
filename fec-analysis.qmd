...
What are the economic demographics of individuals who donate to campaigns? Does one party receive more contributions from individuals greater than $10,000 than another? Does one party receive more contributions from individuals less than $10,000 than another? 
...
```{r}
#creating my second data visualization (by percent)
contributions3_ind_grouped |> 
  ggplot(aes(x=cand_name, fill = ))
